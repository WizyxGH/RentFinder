...
| **Guy Hoquet** (guy-hoquet.com) | 2026-08-15         | 🟡 Candidate       | Relecture : la section `User-agent: *` ne bloque que des endpoints techniques — la liste de ~120 UA vise les outils SEO, pas un bot identifié générique. Sitemap-index déclaré. Reste à identifier la page de liste location Nice avant implémentation.                                                                                                                                                                                                                                                                                                          |
...
| **Nexity** (nexity.fr)          | 2026-08-15         | 🔴 Écartée         | HTTP 403 dès `robots.txt` pour un client HTTP identifié : hostile aux non-navigateurs, pas de contournement (§10). Square Habitat : robots.txt permissif hors recherches, à réétudier (structure ASP.NET).                                                                                                                                                                                                                                                                                                                                                       |
