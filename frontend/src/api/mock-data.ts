...
export const MOCK_LISTINGS: readonly ListingView[] = [
  {
    ...
    district: field(null),
    city: field('nice'),
    latitude: field(43.7016),
    longitude: field(7.266),
...

  {
    ...
    address: field(null),
    district: field('Libération'),
    city: field('nice'),
    latitude: field(43.696),
    longitude: field(7.271),
...

  {
    ...
    district: field(null),
    city: field('nice'),
    latitude: field(43.704),
    longitude: field(7.254),
